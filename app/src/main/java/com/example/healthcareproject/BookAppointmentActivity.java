...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.txtbmbpackagename);
        edt1 = findViewById(R.id.edttxttbfullname);
        edt2 = findViewById(R.id.edttxttbaddress);
        edt3 = findViewById(R.id.edttxttbcontact);
        edt4 = findViewById(R.id.edttxttbpincode);
        dateButton = findViewById(R.id.btnbmcartdatepicker);
        timeButton = findViewById(R.id.btncarttimepicker);
        btnBook = findViewById(R.id.btnltbbooking);
